                ...
                {{-- <div style="" class="infohotel">
                    ...
                    <div class="form-group">
                        <label class="checkbox-inline">
                          <input type="checkbox" value="">Dịch Vụ Ăn Trưa
                        </label>
                        <label class="checkbox-inline">
                          <input type="checkbox" value="">Dịch Vụ Ăn Khuya
                        </label>
                        <label class="checkbox-inline">
                          <input type="checkbox" value="">Dịch Vụ Massage
                        </label>
                        <label class="checkbox-inline">
                          <input type="checkbox" value="">Dịch Vụ Gym
                        </label>
                    </div>
                </div> --}}
